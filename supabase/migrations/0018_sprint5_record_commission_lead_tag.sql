-- Sprint 5 T8: extend record-commission RPC to tag linked lead as past client equivalent.
-- Current lead status model uses "closed" to represent post-close lifecycle state.

    ...
    <section className="bg-[#f8fafc] py-32 px-6">
      <div className="max-w-4xl mx-auto text-center">
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="text-[#c8a96e] opacity-60">
            <svg width="45" height="36" viewBox="0 0 45 36" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <blockquote className="ld-serif text-3xl md:text-4xl font-normal text-slate-800 leading-snug italic max-w-3xl">
            {t('testimonial.quote')}
          </blockquote>

          <div className="flex flex-col items-center gap-1">
            <cite className="not-italic font-semibold text-slate-900 text-lg">{t('testimonial.name')}</cite>
            <span className="text-slate-400 text-sm tracking-wide uppercase font-light">{t('testimonial.role')}</span>
          </div>
        </div>
      </div>
    </section>

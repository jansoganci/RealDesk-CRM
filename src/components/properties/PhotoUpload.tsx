            ...
            {selectedFiles.map((file, index) => (
              <div key={index} className="relative group">
                ...
                <button
                  ...
                  disabled={uploading}
                  className={`absolute top-1 right-1 p-1 ${COLORS.danger.bg} text-destructive-foreground rounded-full opacity-0 group-hover:opacity-100 transition-opacity ${COLORS.danger.hover} disabled:opacity-50`}
                >
                  <X className="h-3 w-3" />
                </button>

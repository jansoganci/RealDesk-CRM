        ...
        <Card className="border-gray-200/80 shadow-sm">
          ...
          <CardContent className="space-y-3 text-sm">
            <div className="flex flex-wrap justify-between gap-2">
              <span className={COLORS.muted.text}>{t('purchaseDetail.overview.price')}</span>
              <span className="font-medium text-foreground">
                {formatCurrency(purchaseContract.purchase_price ?? 0)}
              </span>
            </div>
            <div className="flex flex-wrap justify-between gap-2">
              <span className={COLORS.muted.text}>{t('purchaseDetail.overview.financing')}</span>
              <Badge variant="secondary">{financingLabel(t, pd)}</Badge>
            </div>
            <div className="flex flex-wrap justify-between gap-2">
              <span className={COLORS.muted.text}>{t('purchaseDetail.overview.property')}</span>
        ...
        <Card className="border-gray-200/80 shadow-sm">
          ...
          <CardContent className="space-y-6">
            <div className="space-y-2">
              ...
              <p className={`text-xs ${COLORS.muted.text}`}>{t('purchaseDetail.addenda.fhaHelp')}</p>
            ...
            <div className="space-y-2">
              ...
              <p className={`text-xs ${COLORS.muted.text}`}>{t('purchaseDetail.addenda.vaHelp')}</p>
              <div className="flex flex-wrap items-center gap-2">
                <Input
                  type="file"
                  accept=".pdf,application/pdf"

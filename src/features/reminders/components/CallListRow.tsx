  ...
  return (
    <div
      className={cn(
        ...
        isFirstItem && !isCompleted && 'bg-amber-50/50 border-l-4 border-l-amber-500',
        isCompleted && 'opacity-60',
        !isFirstItem && !isCompleted && 'hover:bg-gray-50'
      )}
    >
      ...
      >
        ...
        <div
          className={cn(
            ...
            !isCompleted && isOverdue && 'bg-red-100 text-red-700',
            !isCompleted && !isOverdue && isCritical && 'bg-red-50 text-red-600',
            !isCompleted && !isCritical && 'bg-emerald-50 text-emerald-600'
          )}
        >
          {isCompleted ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-500">{t('card.contractEndDate')}:</span>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-500">{t('card.currentRent')}:</span>
                <span className="font-medium text-slate-700">{rentAmountFormatted}</span>
              </div>
              ...
              {reminder.reminder_notes && (
                <div className="flex items-start gap-2 mt-2">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">{reminder.reminder_notes}</p>
                  </div>
                </div>
              )}
            </div>

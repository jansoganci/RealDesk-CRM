...
import type { TenantWithContractData, TenantWithContractResult, TenantInsert, ContractInsert } from '../../types';
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium dark:text-slate-200">Step {currentStep} of {STEPS.length}</span>
            <span className="text-sm text-gray-500 dark:text-slate-400">{Math.round(getStepProgress())}% Complete</span>
          </div>

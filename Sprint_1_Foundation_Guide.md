...
| Files | supabase/migrations/\[NNNN\]\_us\_address\_and\_bank\_fields.sql — use next 4-digit index (0001\_, 0002\_, …); see CLAUDE.md *Database migrations (naming)* |
| :---- | :---- |
